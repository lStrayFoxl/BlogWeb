        ...
        <div class="posts col-9">
          ...
          <div class="row add-post">
            ...
            <form action="create.php" method="post">
                <div class="col">
                    <input type="text" value="<?=$name;?>" name="name" class="form-control" placeholder="Имя категории" aria-label="Имя категории">
                </div>
                <div class="col">
                ...
                <div class="col">
                    <button name="btnTopicCreate" class="btn btn-primary" type="submit">Создать категорию</button>
                </div>
            </form>
          </div>
