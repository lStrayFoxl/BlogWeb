    ...
    <div class="container registr_form">
      <form class="row justify-content-md-center" method="post" action="log.php">
        ...
        <div class="mb-3 col-12 col-md-4">
          ...
          <input type="password" class="form-control" id="exampleInputPassword1" name="password" placeholder="введите ваш пароль...">
        </div>
        <div class="w100"></div>
        <div class="mb-3 col-12 col-md-4">
          <button type="submit" class="btn btn-secondary" name="btnLog">Войти</button>
